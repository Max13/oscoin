...
{
    QDesktopServices::openUrl(QUrl("http://www.oscoin.info/wallet/blockchain.php"));
}

void ForumsPage::on_chatButton_clicked()
{
    QDesktopServices::openUrl(QUrl("http://www.oscoin.info/wallet/forums2.php"));
}

void ForumsPage::on_forumButton_clicked()
{
    QDesktopServices::openUrl(QUrl("https://forums.oscoin.info/"));
}

void ForumsPage::on_siteButton_clicked()
{
    QDesktopServices::openUrl(QUrl("http://www.oscoin.info"));
}
