...
#   Bracket the code to profile with ProfileStart("oscoin-qt.prof") and ProfileStop() and recompile
#   Run oscoin-qt through its paces then exit
#   Analyze with:
#      pprof ./oscoin-qt oscoin-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./oscoin-qt oscoin-qt.prof
PROFILE = 0
...
macx:ICON = src/qt/res/icons/oscoin.icns
macx:TARGET = "OSCoin-Qt"
